...
let TradeController = class TradeController {
    ...
    async createTrade(headers, trade) {
        console.log(headers);
        const token = headers['authorization'];
        return await this.tradeService.createTrade(trade, token);
    }
    async fetchTrades(headers, params) {
        try {
            const token = headers['authorization'];
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, app_model_1.TradeDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TradeController.prototype, "fetchTrades", null);
